...
class Spring_Mass(nn.Module):
    ...
    def set_physics_params(self, params=None, **kwargs):
        ...
        translated:
            params (dict, optional): translated
            **kwargs: translated
        
        translated:
            - k: translated (translated [n_points, k_neighbors] translated)
            - m: translated (translated [n_points] translated)
            - damp: translated (translated origin_len translated)
            - rebound_k: translated (translated)
            - fric_k: translated (translated)
            - g: translated (translated [3] translated)
            - k_bc: translated (translated)
            - stretch_ratios: translated (translated)
            - ratio_factor: translated (translated)
            - power: translated (translated)
            - dt: translated (translated)
            - soft_vector: translated (translated)
        """
        if params is None:
            params = kwargs
        else:
